Public Class FrmManCliente
    ...
    Private Sub FrmManCliente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call deshabilitar()
        Call listar()
        DgManCliente.Columns(0).Visible = False
    End Sub
    Sub limpiar()
        Me.TxtNombre.Text = ""
        Me.TxtApellido.Text = ""
    ...
    End Sub
    Sub listar()
        DgManCliente.DataSource = obj.Fun_Listar_Cliente.Tables(0)
        DgManCliente.Columns(0).Visible = False
    End Sub
    Sub habilitar()
    ...
    Sub deshabilitar()
        ...
        DgManCliente.Columns.Item("Eliminar").Visible = True
        DgManCliente.Columns.Item("Eliminar").Visible = False
    End Sub
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        If strFalg = "1" Then
            ...
            If (resp = DialogResult.Yes) Then
                iret = obj.fun_insertar_Cliente(Me.TxtNombre.Text, _
        ...
        If strFalg = "2" Then
            iret = obj.fun_actualizar_cliente(Me.TxtNombre.Text, _
                                             Me.TxtApellido.Text, _
                                             Me.TxtDni.Text, _
                                             Me.TxtRuc.Text, _
                                             Me.TxtDireccion.Text, _
    ...
    Private Sub DgManCliente_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgManCliente.CellContentClick
        Try
            Me.Label9.Text = DgManCliente.CurrentRow.Cells(1).Value
            Me.TxtNombre.Text = DgManCliente.CurrentRow.Cells(2).Value
            Me.TxtApellido.Text = DgManCliente.CurrentRow.Cells(3).Value
            Me.TxtDni.Text = DgManCliente.CurrentRow.Cells(4).Value
            Me.TxtRuc.Text = DgManCliente.CurrentRow.Cells(5).Value
            Me.TxtDireccion.Text = DgManCliente.CurrentRow.Cells(6).Value
            Me.TxtTelefono.Text = DgManCliente.CurrentRow.Cells(7).Value
            Me.TxtEmail.Text = DgManCliente.CurrentRow.Cells(8).Value
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        Else
            ...
            If result = DialogResult.OK Then
                Try
                    For Each row As DataGridViewRow In DgManCliente.Rows
                        ...
                        obj.fun_eliminar_cliente(DgManCliente.Rows(DgManCliente.CurrentRow.Index).Cells(1).Value)
                        Call listar()
                        'If marcado Then
