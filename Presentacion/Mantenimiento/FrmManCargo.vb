Public Class FrmManCargo
    Dim obj As New BCventas.ClsCargo
    ' Dim estado As String
    Public strFalg As String = "0"
    Private Sub FrmManCargo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call deshabilitar()
        Call listar()
        Call habilitar()
        DgManCargo.Columns(0).Visible = False
        cargar_combo_area()
    End Sub
    Sub limpiar()
    ...
    End Sub
    Sub listar()
        DgManCargo.DataSource = obj.Fun_Listar_Cargo.Tables(0)
        DgManCargo.Columns(0).Visible = False
    ...
    Sub deshabilitar()
        ...
        DgManCargo.Columns.Item("Eliminar").Visible = True
        DgManCargo.Columns.Item("Eliminar").Visible = False
    End Sub
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        If strFalg = "1" Then
            ...
            If (resp = DialogResult.Yes) Then
                iret = obj.fun_insertar_Cargo(Me.TxtNombreCargo.Text, _
                                                 Me.TxtIdArea.Text)
                If iret > 0 Then
        ...
        If strFalg = "2" Then
            iret = obj.fun_actualizar_Cargo(Me.TxtNombreCargo.Text, _
                                                Me.TxtIdArea.Text, _
                                                Me.IdCargo.Text)
            If iret = "1" Then
    ...
    Private Sub DgManCargo_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgManCargo.CellContentClick
        Try
            Me.IdCargo.Text = DgManCargo.CurrentRow.Cells(1).Value
            Me.TxtNombreCargo.Text = DgManCargo.CurrentRow.Cells(2).Value
            TxtIdArea.Text = DgManCargo.CurrentRow.Cells(3).Value
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As System.Windows.Forms.Message, ByVal keyData As System.Windows.Forms.Keys) As Boolean
        ...
        If keyData = Keys.Delete Then
            ...
            If result = System.Windows.Forms.DialogResult.Yes Then
                ...
                Dim objeliminar As New BCventas.ClsCargo
                obj.fun_eliminar_cargo(DgManCargo.Rows(DgManCargo.CurrentRow.Index).Cells(1).Value)
                Call listar()
            End If
        End If
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        ...
        Else
            ...
            If result = DialogResult.OK Then
                Try
                    For Each row As DataGridViewRow In DgManCargo.Rows
